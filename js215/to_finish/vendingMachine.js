...
//- output arry: sorted in desc order , can be empty (if no change) 
//- If productNumber is invalid (out of range) you should return the string:
//     "Enter a valid product number".
// - If money is not enough to buy a certain product you should return the
//     string: "Not enough money for this product".
...
//-      - find the changeAmiunt in the changeArray 
//          - if found place it the objects 
//       - if it's not found 
//          itertaion ( continue until the amount = 0) 
//           - find the largest coin that is less than the change 
//           - dedecut it from the changeAmoutn and save to a changeAmunt var 
//           - push it to array 
//           - ...
// 
...
function calculateCoins(changeAmount, allCoins) {
   let foundCoins = allCoins.find(coin => coin === changeAmount);
   let coinsArray = []; 
...
console.log(calculateCoins(360, [500, 200, 100, 50, 20, 10]));
...
// //the higest possible coin
// console.log(vendingMachine(products, 310, 9));  // {product: 'Small snack', [200, 100, 20]}
