...
function isGrater(numArr, inputNum) {

  if (numArr.some(num => num > inputNum)) {
    console.log(`${allNum} includes number that is grater than ${inputNum}`);
  } else {
    console.log(`${allNum} doesn't include numb that is grater than ${inputNum}`);
  }
}
